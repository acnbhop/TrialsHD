...
PS_OUTPUT PS(VS_OUTPUT psIn, float2 screenpos : VPOS) : COLOR
{
	...
	float alpha = texNCombine2.r;

	outStruct.rtColorEmi = float4(texNCombine1.rgb * materialColor * (materialPropertiesM.y * texCombine.a), alpha);	//texNCombine2.b + materialPropertiesM.w;
