...
PS_OUTPUT PS(VS_OUTPUT psIn, float2 screenpos : VPOS) : COLOR
{
    PS_OUTPUT outStruct;
	...
	//float alpha = frac(screenpos.y * 0.5) >= 0.25f;
	float alpha = texNCombine2.r * materialColor.a;

	outStruct.rtColorEmi = float4(texNCombine1.rgb * materialColor.rgb * (materialPropertiesM.y * texCombine.a), alpha);	//texNCombine2.b + materialPropertiesM.w;
