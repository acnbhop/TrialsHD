...
PS_OUTPUT PS(VS_OUTPUT psIn) : COLOR
{
	...
	outStruct.rtColorEmi = float4(texNCombine1.rgb * materialColor * (materialPropertiesM.y * texCombine.a) + reflectionColor * 0.3f * texNCombine2.b, (materialPropertiesM.w + texNCombine2.b * dot(reflectionColor, reflectionColor) * 0.001f) * 0.5);
